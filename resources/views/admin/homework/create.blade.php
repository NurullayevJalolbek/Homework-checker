...
<nav aria-label="breadcrumb" class="mt-3">
    <ol class="breadcrumb p-2 rounded text-white" style="background-color: #1E1E2E;">
        ...
        <li class="breadcrumb-item active text-white" aria-current="page">
            <a href="{{route('admin.homework.create')}}" class="text-white text-decoration-none">
                Create
            </a>
        </li>
    </ol>
                    ...
                    <form action="{{route('admin.homework.store')}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{route('admin.homework.index')}}" class="btn btn-primary" style="height: 40px;">Orqaga</a>
                            </div>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="exercise_id" id="exercise_id" value="{{ old('exercise_id') }}">
                                    @error('exercise_id')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="task_condition" value="{{ old('task_condition') }}">
                            ...
                            <div class="col-md-4" style="margin-bottom: 10px;">
                                ...
                                <div class="input-group">
                                    <input type="datetime-local" name="due_date" class="form-control" id="due_date_input" value="{{ old('due_date') }}">
